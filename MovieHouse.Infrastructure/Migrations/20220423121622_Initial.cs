        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BirthCityId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    BirthCountryId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Actors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Actors_Cities_BirthCityId",
                        column: x => x.BirthCityId,
                        principalTable: "Cities",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Actors_Countries_BirthCountryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewText = table.Column<string>(type: "nvarchar(700)", maxLength: 700, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersMoviesReviews", x => new { x.ApplicationUserId, x.MovieId });
                    table.ForeignKey(
                        name: "FK_UsersMoviesReviews_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UsersMoviesReviews_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2df41905-09c5-4fda-8969-82198491b4b3", "Bulgaria" },
                    { "47d41ce9-16a8-4432-9db2-a00e0641069d", "Italy" },
                    { "ac8fe54f-9590-4634-80e1-61f99c423de4", "Germany" },
                    { "d05d0177-61c3-40ac-a106-25e3d950e68b", "France" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "0085ed9d-dd87-4f6e-a3f8-07bd6a9fd234", "2df41905-09c5-4fda-8969-82198491b4b3", "Sofia" },
                    { "00be197c-e96d-448e-b6b0-95e9561b6f1e", "47d41ce9-16a8-4432-9db2-a00e0641069d", "Rome" },
                    { "25a950ad-9e91-44ba-a3e3-a35ff430afcf", "ac8fe54f-9590-4634-80e1-61f99c423de4", "Berlin" },
                    { "3a2add9b-844c-4415-82f3-737835f2ebe6", "d05d0177-61c3-40ac-a106-25e3d950e68b", "Paris" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_Actors_BirthCityId",
                table: "Actors",
                column: "BirthCityId");

            migrationBuilder.CreateIndex(
                name: "IX_Actors_BirthCountryId",
                table: "Actors",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersMoviesReviews_MovieId",
                table: "UsersMoviesReviews",
                column: "MovieId");
        }
